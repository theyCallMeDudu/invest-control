...
class CreateOperationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'currency_type'     => 'required|string|in:USD,EUR,BRL',
    ...
    public function messages()
    {
        return [
            ...
            'currency_type.required'     => 'The currency type is mandatory.',
            'currency_type.in'           => 'The selected currency type is invalid.',
